...
@Component({
  selector: 'app-tablasentirtodo',
  templateUrl: './tablasentirtodo.component.html',
  styleUrls: ['./tablasentirtodo.component.css']
})
export class TablasentirtodoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.subnombre1 = this.data[0].totalidadejercicios[0].subnombre    
    this.subnombre2 = this.data[0].totalidadejercicios[1].subnombre
